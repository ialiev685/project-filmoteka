    ...
    const instance = basicLightbox.create(
      ...
      <div class="modal">
       ...
       src="${teamImageMobile}" alt="team-foto">
          ...
          <ul class="list-no-style list-team-links">
            <li>
                <a href="https://github.com/Dima-Penzev" target="_blank" rel="noopener noreferrer" class="link-no-style member-link">Dmitriy</a>
            </li>
            <li>
                <a href="https://github.com/SvetlanaLeb" target="_blank" rel="noopener noreferrer" class="link-no-style member-link">Svetlana</a>
            </li>
            <li>
                <a href="https://github.com/KaterinaGerts" target="_blank" rel="noopener noreferrer" class="link-no-style member-link">Katharine</a>
            </li>
            <li>
                <a href="https://github.com/denis-tsibaev" target="_blank" rel="noopener noreferrer" rel="noopener noreferrer" class="link-no-style member-link">Denis</a>
            </li>
            <li>
                <a href="https://github.com/JuliaZaykaS" target="_blank" rel="noopener noreferrer" class="link-no-style member-link">Julia</a>
            </li>
            <li>
                <a href="https://github.com/ialiev685" target="_blank" rel="noopener noreferrer" class="link-no-style member-link">Ilfat</a>
            </li>
            <li>
                <a href="https://github.com/ABoklogov" target="_blank" rel="noopener noreferrer" class="link-no-style member-link">Alexei</a>
            </li>
            <li>
                <a href="https://github.com/Grek-88" target="_blank" rel="noopener noreferrer" class="link-no-style member-link">George</a>
            </li>
          </ul>
          <div class="progect-link">
                <a href="https://github.com/ialiev685/project-filmoteka" target="_blank" rel="noopener noreferrer" class="link-no-style member-link ">Project link</a>
          </div>
        </div>`,
      {
        onShow: instance => {
